...
public class CategoryPage {
    ...
    private By createdCategoryName = By.name("categoryFilter_name");
    ...
    public void populateCategoryName(String categoryName) {
    ...
    public void populateCreatedCatName(String categoryName){
        driver.findElement(createdCategoryName).sendKeys(categoryName);
    }
    ...
    public By getCreated() {
        return created;
    }

    public void setCreated(By created) {
        this.created = created;
    }

    public By getTableBody() {
        return tableBody;
    }

    public void setTableBody(By tableBody) {
